...
contract SURGE is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // initialize supply
    constructor() {
        // The contract holds the whole supply of its token
    ...
    address private stableAddress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD

    function changeStablePair(
        address newStablePair,
        address newStableAddress
    ) external onlyOwner {
        require(
    ...
    function getBNBPrice() public view returns (uint) {
        ...
        // If on the pair token0 is BUSD, then token1 must be WBNB
        ...
        //   _reserve0   uint112 :  7082620237222431536621
        //   _reserve1   uint112 :  4387560467672787018036261
